...
void OpenGLEngine::BeginClipRect(const CMyRect& clipRC)
{
	glEnable(GL_SCISSOR_TEST);
	glScissor(clipRC.left, m_nHeight - clipRC.bottom, clipRC.Width(), clipRC.Height());
}

void OpenGLEngine::EndClipRect()
{
